...
data.sub_name = 'MPC086_LJY'; % ex) MPC000_LDH
...
while true
    ...
    DrawFormattedText(theWindow, double('시작하시려면 `클릭`하세요'), W*(1/2)-scale_H*(0.9), H*(6/10), white,[],[],[],1.2);
    DrawFormattedText(theWindow, double('스캔실에서의 감정과 몰입을 떠올려주세요'), W*(1/2)-scale_H*(1.4), H*(5.5/10), white,[],[],[],1.2);
    Screen('TextSize', theWindow, fontsize);
