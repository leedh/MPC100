...
## J.J., 2019. 02. 18: Changed!!!!! (getting ITK-format linear/nonlinear transformation files)
nonfeatoptions.add_argument('-ITKcoreg', dest="ITKcoreg", default="", help='File name of the mat-file describing the affine registration (e.g., FSL FLIRT) of the functional data to structural space (.mat file) in ITK format.')
nonfeatoptions.add_argument('-ITKaffine', dest="ITKaffine", default="", help='File name of the mat-file describing the affine registration (e.g., ANTs antsRegistrationSyN.sh) of the structural data to MNI152 space (.mat file) in ITK format.')
nonfeatoptions.add_argument('-ITKwarp', dest="ITKwarp", default="", help='File name of the warp-file describing the non-linear registration (e.g., ANTs antsRegistrationSyN.sh) of the structural data to MNI152 space (.nii.gz).')
...
ITKcoreg = args.ITKcoreg;
ITKaffine = args.ITKaffine;
ITKwarp = args.ITKwarp;
if len(ITKcoreg) != 0 and len(ITKaffine) != 0 and len(ITKwarp) != 0:
    print('  - ITK transformation files will be used.')
    aromafunc.register2MNI_ITK(fslDir, melIC, melIC_MNI, ITKcoreg, ITKaffine, ITKwarp)
else:
    print('  - FSL transformation files will be used.')
