...
% Last Modified by GUIDE v2.5 12-Jul-2019 15:51:47
...
if ~exist('basedir', 'var') % In order to make program don't run simultaneously
    ...
    if length(expt_param.eyelink_filename) >= 8
       error('Eyelink file name is too long! \nEyelink file name have to be less than 8 char which is now %d (%s)', ...
        length(expt_param.eyelink_filename), expt_param.eyelink_filename) 
    end
    ...
    global ip port
    ip = char(get(handles.path_ip_edit, 'string'));
    port = str2num(get(handles.path_port_edit, 'string'));
...
function path_ip_edit_Callback(hObject, eventdata, handles)
% hObject    handle to path_ip_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of path_ip_edit as text
%        str2double(get(hObject,'String')) returns contents of path_ip_edit as a double


% --- Executes during object creation, after setting all properties.
function path_ip_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to path_ip_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function path_port_edit_Callback(hObject, eventdata, handles)
% hObject    handle to path_port_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of path_port_edit as text
%        str2double(get(hObject,'String')) returns contents of path_port_edit as a double


% --- Executes during object creation, after setting all properties.
function path_port_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to path_port_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function eye_file_edit_Callback(hObject, eventdata, handles)
% hObject    handle to eye_file_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of eye_file_edit as text
%        str2double(get(hObject,'String')) returns contents of eye_file_edit as a double


% --- Executes during object creation, after setting all properties.
function eye_file_edit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to eye_file_edit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
